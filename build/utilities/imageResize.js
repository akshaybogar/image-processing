            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(path_1.default.join(imagesFolder, filename))
                            .resize(width, height)
                            .jpeg({ quality: 50 })
                            .toFile(path_1.default.join(processedImagesFolder, filename.split('.')[0] +
                            '_' +
                            width.toString() +
                            '_' +
                            height.toString() +
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, path_1.default.join(processedImagesFolder, filename.split('.')[0] +
                            '_' +
                            width.toString() +
                            '_' +
                            height.toString() +
                ...
                case 2:
                    err_1 = _a.sent();
                    console.log('Error resizing image ', err_1);
